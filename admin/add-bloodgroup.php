...
{
		$error="This BloodGroup Already Exist!";
}
else{
	$query = mysqli_query($con,"insert into tblbloodgroup(BloodGroup,BloodVolume,DateCreated) value('$bloodgroup','0','$dateCreated')");
	if($query == True)
	{
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add New Blood Group </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Add New Blood Group</div>
