...
$query=mysqli_query($con,"update tblpages set Detail='$pagedetails' where Type='$pagetype'");
if($query == True) {
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
                  ...
                  <option value="manage-pages.php?type=tips">Tips</option>
                </select>
												</div>
											</div>
...
$ret=mysqli_query($con,"SELECT Detail from tblpages where Type='$pagetype'");
