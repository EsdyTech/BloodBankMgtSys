...
{
$id=$_GET['del'];
$que = mysqli_query($con,"DELETE FROM tblbloodgroup WHERE Id='$id'");
if($que == TRUE){
...
<td>
<a href="manage-bloodgroup.php?del=<?php echo $row['Id'];?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
