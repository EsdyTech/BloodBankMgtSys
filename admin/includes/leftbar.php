...
<li><a href="#"><i class="fa fa-user"></i> Blood Donation</a>
<ul>
<li><a href="blood-donation.php">Add Blood Donation</a></li>
<!-- <li><a href="manage-blooddonation.php">Manage Blood Donation</a></li> -->
<li><a href="manage-donordonation.php">Manage Donor Donations</a></li>
</ul>
</li>
<li><a href="manage-bloodrequesters.php"><i class="fa fa-edit"></i>Blood Requesters</a></li>
				...
				<li><a href="manage-conactus.php"><i class="fa fa-desktop"></i> Manage Messages</a></li>
